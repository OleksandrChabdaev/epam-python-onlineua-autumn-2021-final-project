...
class Populate:
    ...
    def populate():
        ...
        employee_4 = Employee('First Name 4', 'Last Name 4', date(2004, 4, 14), department_1.id, 4000)
        employee_5 = Employee('First Name 5', 'Last Name 5', date(2005, 5, 15), department_2.id, 5000)
        employee_6 = Employee('First Name 6', 'Last Name 6', date(2006, 6, 16), department_3.id, 6000)
        employee_7 = Employee('First Name 7', 'Last Name 7', date(2007, 7, 17), department_1.id, 7000)
        employee_8 = Employee('First Name 8', 'Last Name 8', date(2008, 8, 18), department_2.id, 8000)
        employee_9 = Employee('First Name 9', 'Last Name 9', date(2009, 9, 19), department_3.id, 9000)
